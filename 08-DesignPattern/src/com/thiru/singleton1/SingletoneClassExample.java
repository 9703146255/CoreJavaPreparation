...
final public class SingletoneClassExample {
	...
	static SingletoneClassExample s=null;//lazy initiolisation////
	...
	static SingletoneClassExample getInstance()
	{
		...
		if(s==null)
		{
			s= new SingletoneClassExample();
		}
		 return s; ////it will create object first time only //so only one time will be created
	}
}
