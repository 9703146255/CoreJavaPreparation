...
/*
 ...
 ==============================================
 mp.get(500050)  //based on key we will get values
 
 Deletion of elements from the map
 ==================================
 mp.remove(key),mp.remove(key,value) ,mp.clear ==> delete total 
 
 Verification of keys from the map
 verification of values from the map
 updation of elements in the map

 Set intrf==>  keySet(); ==> only keys
 Collection intrf ==>values(); ==> only values
 entrySet() ==> both keys, values we get
...
public class Map5 {
	...
	public static void main(String[] args) {
	    ...
	    //we will get "values" ==>mp.get(key)==>values
	                          // ==>key ==> keys
	    for(Integer key:Keys)
	    {
