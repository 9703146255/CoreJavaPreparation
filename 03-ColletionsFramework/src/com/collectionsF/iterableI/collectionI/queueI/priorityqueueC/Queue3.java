...
RETRIEVAL TOP VALUE IN THE GIVEN VALUES
=========
peak()
...
public class Queue3 {
	...
	public static void main(String[] args) {
		...
		q.offer(8);
		q.offer(9);
		//q.offer(null);  not accept the null values
		q.offer(6);
		...
		System.out.println("PriorityQueue elements peek :"+q.peek());
		System.out.println("PriorityQueue elements :"+q);
		System.out.println("PriorityQueue elements poll :"+q.poll());
		//System.out.println("PriorityQueue elements remove :"+q.remove());
		System.out.println("PriorityQueue elements :"+q);
		//note: 
		
		//Queue: in queue internally arrays implementation is there 
		//that array is OBJECT type of array present
		//object array value==>null==> peak/poll null
