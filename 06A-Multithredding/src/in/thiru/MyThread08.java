...
setting the thread name by default thread-1 we have
	...
	THREAD - 7:	i can make sleeping of 2 child threads also for some time for program tracking	 
	...
	//	step:2 write run() method 
		public void run()
		{
		  ...
		  { 
			...
			try {
				Thread.sleep(1000);
			} catch (InterruptedException e) {			//XXXXXXXXXXXXXX i make sleeping of child thread for some time
				e.printStackTrace();
			}
		  }
		}
