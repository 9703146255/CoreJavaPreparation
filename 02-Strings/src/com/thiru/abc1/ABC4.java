...
//		String x="aradhya brillian center";
//		char[] y=x.toCharArray();
//		int len=y.length;
//		
//		//WE ARE CONVERTED FIRST CHARACTER AS UPPER CASE
//		y[0]=(char) (y[0]-32);
//		
//		int i=0;
//		while(i != len)
//		{
//			//AT THE TIME OF SPACE TO CONVERT NEXT CHARACTER TO UPPER CASE
//			if(y[i] == ' ')
//			{
//				y[i+1]=(char) (y[i+1]-32);
//			}
...
//		System.out.println(y);
		...
		//ARADHY BRILLION CENTRE
		String s="ARADHY BRILLION CENTRE";
