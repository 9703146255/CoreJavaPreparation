...
step:1==> replace, convert lower (or) upper
step:2==> to convert string to char
step:3==> to sort ascending 
*/

public class ABC2_CheckTwoStringAnagrmsOrNot {

	public static void main(String[] args) {
		String x="HE is  AraDHYA";
		String y="IS he  HradaYA";  //String(replace,toLowerCase)=>toCharArray=> sort=>equal
