...
1) EXCEPTION NAME/PACKNAME        ==>java.lang.ArithmeticException
     ...
     public static void main(String[] args) throws FileNotFoundException {
		  System.out.println("PROGRAM EXECUTION START");
			...
			catch(ArithmeticException Ae)
			{
				...
				//print only message
				System.out.println("print only message : "+Ae.getMessage());////
			    System.out.println("get stack trace  :"+Ae.getStackTrace());////
