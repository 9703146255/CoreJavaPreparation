...
/*
 step-1:
 */
public class Arrays18_N22TheNumOfOccurenceOfCharString {
...
//		
		...
		str1=str1.replace(str2, "");   //hello, l ==>inplace of string 2times l letter replaced with ""(empty)
		int finalLength=str1.length();
		System.out.println(wordLen-finalLength);
